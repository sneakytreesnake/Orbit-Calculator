...
#Make Windows not have close button at top


#Make a minimum yres
#word ecentricity better
#Make inclination middle of page and offset to work with all screensizes and inimize overlap
...
#BUG BOARD
#Inclination board is not generating correct values for linelength and maybe mini planet
...
class App():
    def __init__(self, groot):
        ...
        def orbitcalc():
            ...
            def looprun():
                ...
                self.dvchangelab.grid(row = 10, column = 1, columnspan = 1, sticky = W)
                self.tdvchangelab.grid(row = 10, column = 2, columnspan = 2, sticky = W)
                ...
                self.waitnes.grid(row = 10, column = 1, columnspan = 3)
    ...
    #GOES UP BOT NOT DOWN
            ...
            def orootwindow():
                if self.orootopen == 0:
                    ...
                    Label(self.oroot,text = "|",background='silver').grid(row = 26 , column = 2)
                    Label(self.oroot,text = "|",background='silver').grid(row = 27 , column = 2)
                    Label(self.oroot,text = "|",background='silver').grid(row = 28 , column = 2)
                    Label(self.oroot,text = "|",background='silver').grid(row = 29 , column = 2)
                    Label(self.oroot,text = "|",background='silver').grid(row = 30 , column = 2)
                    Label(self.oroot,text = "|",background='silver').grid(row = 31 , column = 2)
                    ...
                    if self.col == 1:
                        ...
                        Label(self.oroot, text = "Manoeuvre",font = self.ArialBg,background='silver').grid(row = 31 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "A movement.",background='silver').grid(row = 31 , column = 3, columnspan = 1, sticky = W)
                        ...
                        Label(self.oroot, text = "Distance from the current position to Bodies centre of mass.").grid(row = 1 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Apoapsis",font = self.ArialBg).grid(row = 2 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Point of orbit that is furthest from body. Lowest possible orbital speed is here.").grid(row = 2 , column = 3, columnspan = 1, sticky = W)
                        

                        Label(self.oroot, text = "Body",font = self.ArialBg).grid(row = 3 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "The planet/sun/moon a satellite is orbiting.").grid(row = 3 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Centre of Mass",font = self.ArialBg).grid(row = 4 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Point where all mass is concentrated. Assumed Centre of Mass in centre of body for calculations.").grid(row = 4 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Eccentricity",font = self.ArialBg).grid(row = 5 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "A measure of how much a conic section deviates from being circular.").grid(row = 5 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Delta V",font = self.ArialBg).grid(row = 6 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Change in velocity.").grid(row = 6 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Equatorial Plane",font = self.ArialBg).grid(row = 7 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Plane parrellel with equaotiral line.").grid(row = 7 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Burn Time",font = self.ArialBg).grid(row = 8 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How long an engine can run for before burnout.").grid(row = 8 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Burnout",font = self.ArialBg).grid(row = 9 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Shutdown of engine due to lack of fuel.").grid(row = 9 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Inclination",font = self.ArialBg).grid(row = 10 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Angle of orbit measured from equatorial plane.").grid(row = 10 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Orbit",font = self.ArialBg).grid(row = 11 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Path of satellite around a body.").grid(row = 11 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Periapsis",font = self.ArialBg).grid(row = 12 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Point of orbit that is closest to body. Highest possible orbital speed is here.").grid(row = 12 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Period",font = self.ArialBg).grid(row = 13 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Time required for one circuit of orbit.").grid(row = 13 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Prograde",font = self.ArialBg).grid(row = 14 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "The direction in the orbit is travelling.").grid(row = 14 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Retrograde",font = self.ArialBg).grid(row = 15 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "The direction opposite from the direction the orbit is travelling.").grid(row = 15 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Semi-Major Axis",font = self.ArialBg).grid(row = 16 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Half of the longest part of an orbit.").grid(row = 16 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Semi-Minor Axis",font = self.ArialBg).grid(row = 17 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Half of the shortest part of an orbit.").grid(row = 17 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Focal Length",font = self.ArialBg).grid(row = 18 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Distance from the centre of orbit to where the orbiting body is.").grid(row = 18 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Gravational Parameter",font = self.ArialBg).grid(row = 19 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Expressed as μ and and shown in unit m^3/s. Product of Gravational Constant and mass of body.").grid(row = 19 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Gravational Constant",font = self.ArialBg).grid(row = 20 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Use to calculate the attractive forces of two bodies as proportionate to their own mass. Approximately 6.674x 10 ^ -11 Nm^2/kg^2.").grid(row = 20 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Velocity",font = self.ArialBg).grid(row = 21 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How fast an object is travelling in a praticular direction.").grid(row = 21 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Radar Altitude",font = self.ArialBg).grid(row = 22 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How high something is from the surface beneath it. Eg. Atltiude of spacecraft from surface of body.").grid(row = 22 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Mass",font = self.ArialBg).grid(row = 23 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How much matter is in an object. The more matter the 'heavier' when combined with gravational acceleration.").grid(row = 23 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Gravational Acceleration",font = self.ArialBg).grid(row = 24 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Measurement of how much acceleration an object will inherit when no other forces are active.").grid(row = 24 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Centripetal Force",font = self.ArialBg).grid(row = 25 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How much force is acting on an object to keep it in the circle/ellipse that it is travelling in. Expressed as Fc.").grid(row = 25 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Specific Impulse",font = self.ArialBg).grid(row = 26 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Expressed as Isp, and measured in seconds. It is a measurement of how effeciency of converting fuel into thrust.").grid(row = 26 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Wet Mass",font = self.ArialBg).grid(row = 27 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Mass of a spacecraft when full of fuel.").grid(row = 27 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Dry Mass",font = self.ArialBg).grid(row = 28 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "Mass of a spacecraft when fuel is empty.").grid(row = 28 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Thrust",font = self.ArialBg).grid(row = 29 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How much force an engine can exhert.").grid(row = 29 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Fuel Mass",font = self.ArialBg).grid(row = 30 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "How much mass of a spacecraft is fuel.").grid(row = 30 , column = 3, columnspan = 1, sticky = W)

                        Label(self.oroot, text = "Manoeuvre",font = self.ArialBg).grid(row = 31 , column = 1, columnspan = 1, sticky = W)
                        Label(self.oroot, text = "A movement.").grid(row = 31 , column = 3, columnspan = 1, sticky = W)
                    
                    self.glosscombust = Button(self.oroot, text = "Close", command = orootwindowclose)
                    self.glosscombust.grid(row = 32, column = 1, columnspan = 3)
                ...
                if self.frootopen == 0:
                    ...
                    def OBERTHOPEN():
                        ...
                        if self.OBERTHOP == 1:
                            ...
                            self.l13 = Label(self.froot, text = "kinetic energy is increased as speed increases. However, since the equation for kinteic energy")
                            self.l13.grid(row = 4 , column = 1, columnspan = 10, sticky = W)
                            self.l14 = Label(self.froot, text = "is increased as speed increases. However, since the equation for kinteic energy is Ek = 0.5mv^2,")
            ...
            def zoom():
                ...
                self.zoom = self.ZoomSlide.get() * (int(self.canvasy)/200) # + 100 # self.zoom
           ...
           # b = tkinter.tix.Balloon(self.groot)
            ...
            self.planetcombobox.grid(column=1, row=15, columnspan = 2)
            ...
            self.entercorebutton = Button(groot,text = "Set Body Diameter (m)", command=loopchangecore)
            ...
            self.shipmassBox.grid(row=16, column=1)
            ...
            self.LINELAB1.grid(row=18, column=1, columnspan = 5) #row?

            self.LINELAB3 = Label(groot, text="- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -", font="arial",background='silver')
           ...
           # Label(self.groot, text="- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -", font="arial",background='silver').grid(row=25, column=1, columnspan = 5)
            ...
            self.shiprunbutton.grid(row=17, column=1, columnspan = 2)
            self.resetdv.grid(row=13, column=4, columnspan = 2, sticky = W)
            self.changeposition.grid(row=12, column=3, columnspan = 2)
            self.crootwindowopen.grid(row = 29, column = 3, columnspan = 4, sticky = W)
            self.prootwindowopen.grid(row = 29, column = 1, columnspan = 4, sticky = W)
            self.frootwindowopen.grid(row = 29, column = 2, columnspan = 4, sticky = W)
            self.orootwindowopen.grid(row = 29, column = 4, columnspan = 4, sticky = W)
            ...
            self.entershipmass.grid(column=2, row=16, columnspan = 2, sticky = W)
            ...
            self.LINELAB2.grid(row=14, column=1, columnspan = 4)
        ...
        def update_frame():
          ...
          #  print (self.Vchange)
           # print (self.intVchange)
            ...
            self.LineLength = self.H*(44.26 /self.planetradius)
            if self.LineLength <= 0.1:
                self.LineLength = 0.1
            print (self.H, "HEIGHT")
            print (self.OvalH, "OH")
            print (self.LineLength, "LL")

            #self.miniplanet = self.planetradius/ (self.L / 55)
            #self.LineLength = self.L*(44.26 /self.planetradius)
    ...
    #TRUE BASELINE
            ...
            self.w.create_text((self.ovalheadway + self.UA/self.S + self.planetsize)/2 + self.ovalheadway/2  , self.canvasy  - self.canvasy/100 - 50 , text = (self.periv , int(self.A),"m"), font = self.ArialBg) #A
           ...
           # self.tri6 =  (self.canvasy -125) + (self.hypot * ( math.sin (self.theta2)))
            ...
            if self.miniplanet <= 44.26:
                ...
                print ("Planet is 2 big 5 me")
                self.w.create_oval(self.canvasx - 125+ 44.26, self.canvasy -125 + 44.26, self.canvasx - 125- 44.26, self.canvasy -125 - 44.26, fill = self.planetcolor, outline = "white")
                self.w.create_arc(self.canvasx - 85, self.canvasy -85 , self.canvasx - 165, self.canvasy -165, extent = -1 * self.incline, width = 2, style = ARC)
                self.w.create_line(self.canvasx - 200, self.canvasy -125, self.canvasx - 50, self.canvasy -125, width = 3, fill = "darkred", dash = (20,5))
        ...
        def tutwindowopen():
            ...
            tutcombust.grid(row = 200, column = 1, columnspan = 1)
        ...
        def optionmenu():
            ...
            if oprootopen == 0:
                ...
                def fullscreen():
                    ...
                    self.screenx = oproot.winfo_screenwidth()
                    self.screeny = oproot.winfo_screenheight()
                ...
                def resscreen():
                    ...
                    reschange = 1
                    fullscreen = 0
                    print (int(self.yBox.get()))
                    
                    tcanvasx = self.xBox.get()
                    tcanvasy = self.yBox.get()
                ...
                self.xBox = Entry(oproot, textvariable=desxres)
                self.xBox.grid(row=3, column=1)

                self.yBox = Entry(oproot, textvariable=desyres)
                self.yBox.grid(row=4, column=1)

                resset = Button(oproot, text="Confirm Resolution", command=resscreen)
                resset.grid(row = 3, column = 2, rowspan = 2)

                
                fulopen = Button(oproot, text="FullScreen", command=fullscreen)
                fulopen.grid(row = 1, column = 1)
                
                winopen = Button(oproot, text="Windowed", command=windowed)
                winopen.grid(row = 1, column = 2)
        ...
        optopen = Button(groot, text="Open Options", command=optionmenu)
        optopen.grid(row = 3, column = 1)
