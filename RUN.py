...
# FOR USERS EDITING THIS SCRIPT

#If you wish to edit this script, you can do so freely, aslong as you acknowledge that I have created it
#(Make a note somewhere that it was originally created by me. Can just be a footnote)
...
Label(blurbwindow, text = "to variables that exceed escape velocity. To fix this").grid(row = 142,sticky = W)
